...
/*        for (int i = 0; !StdIn.isEmpty(); i++) {
    ...
    System.out.println("Time to build tree was: " +time+ " milliseconds");



    int count = st.numberRed();
	System.out.println("The Number of Red Links is: " +count);
    }
}
